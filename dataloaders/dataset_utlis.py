...
class CIFAR10_(datasets.CIFAR10):
    ...
    def __init__(self, root,  train, transform, target_transform, download=True):

        super(CIFAR10_, self).__init__(root, transform=transform,
...
#         # # weird that mnist targets are tensors converting to list for better rep
...
#         return  super(MNIST_RGB, self).__getitem__(index)
#         # img, target = super(MNIST_RGB, self).__getitem__(index)
#         # print(img.shape)
